...
#define CHG_PARAM_SIZE		168
#define SMEM_CHG_PARAM_SHARE	16
#define SMEM_CHG_PARAM_CYCLE	32
...
typedef struct {
	...
	uint8_t		i2c_1st_data;
	uint8_t		i2c_2nd_data;
	uint16_t	buck_ctrl_wait_time;
	uint16_t	idc_wait_time;
