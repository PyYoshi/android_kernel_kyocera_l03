...
#define OEM_HKADC_MONITOR_TIME_1S		2500
...
#define HKADC_UEVENT_NOTIFY_COUNT			12

#define HKADC_SUSPEND_MONIT_FREQ		(60 * 10)

#define HKADC_PA_THERM_MONIT_FREQ			2
#define HKADC_CAMERA_TEMP_MONIT_FREQ		2
#define HKADC_SUBSTRATE_THERM_MONIT_FREQ	2
#define HKADC_USB_THERM_MONIT_FREQ			2
