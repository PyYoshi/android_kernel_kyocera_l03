...
oem_chg_param_charger oem_param_charger = {
	...
	.chg_cool_tmp = 0x0A,			//cool-bat-decidegc
	.chg_warm_tmp = 0x2D,			//warm-bat-decidegc
	.wait_chg_on = 0x34,
	.wait_chg_off = 0x2F,
	.chg_adp_tmp1 = 0x0A,
	.chg_adp_tmp2 = 0x32,
	...
	.normal_chg = 0x10EA,			//vddmax-mv
	.cool_chg = 0x109A,				//cool-bat-mv
	.warm_chg = 0x109A,				//warm-bat-mv
	.uim_undete_chg = 0x109A,		//nouim(cool-bat-mv/warm-bat-mv)
	.reserve4_1 = 0xFFFF,
	.reserve4_2 = 0xFFFF,

	.rechg_delta_volt = 0x012C,
	.initial_delta_volt = 0x00A0,	//vbatdet-delta-mv

	.maint_chg_vin = 0x10CC,		//vinmin-mv
	.reserve6_1 = 0xFFFF,
	.reserve6_2 = 0xFFFF,
	.reserve6_3 = 0xFFFF,
	...
	.i_chg_norm = 0x076C,		//ibatmax-ma
	.i_chg_cool = 0x05DC,		//ibatmax-cool-ma
	.i_chg_warm = 0x05DC,		//ibatmax-warm-ma
	.i_chg_finish = 0x0064,		//ibatterm-ma
	.i_chg_nouim  = 0x07D0,
	.reserve8_1 = 0xFFFF,
...
static void oem_param_charger_init(oem_chg_param *ptr)
{
	...
	SET_CHG_PARAM(0xFF, charger, i2c_1st_data);
	SET_CHG_PARAM(0xFF, charger, i2c_2nd_data);
	SET_CHG_PARAM(0xFFFF, charger, buck_ctrl_wait_time);
	SET_CHG_PARAM(0xFFFF, charger, idc_wait_time);
...
void oem_param_deterioration_status_backup(int batt_deterioration_status)
{
	...
	if(oem_param_cycles.batt_deteriorationstatus != batt_deterioration_status) {
		...
		pr_debug("batt_deteriorationstatus[%d]\n",
