...
#define MSMFB_MIPI_REG_WRITE  _IOWR(MSMFB_IOCTL_MAGIC, 170, \
						struct disp_diag_mipi_write_reg_type)
#define MSMFB_MIPI_REG_READ   _IOWR(MSMFB_IOCTL_MAGIC, 171, \
						struct disp_diag_mipi_read_reg_type)
#define MSMFB_DISPLAY_STANDBY _IOW(MSMFB_IOCTL_MAGIC, 172, unsigned int)
#define MSMFB_GET_STATUS      _IOR(MSMFB_IOCTL_MAGIC, 173, \
...
#define MSMFB_CHANGE_TRANSFER_RATE _IOW(MSMFB_IOCTL_MAGIC, 176, uint32_t)
#define MSMFB_DISP_MSG_OUT    _IOW(MSMFB_IOCTL_MAGIC, 177, \
						struct disp_diag_message_out)
#define MSMFB_ERR_CHK_START   _IO(MSMFB_IOCTL_MAGIC, 178)
#define MSMFB_ERR_CHK_STOP    _IOR(MSMFB_IOCTL_MAGIC, 179, \
						struct disp_diag_err_check_type)
#define MSMFB_CURRENT_ERR_STAT _IOR(MSMFB_IOCTL_MAGIC, 180, \
						struct disp_diag_err_check_type)
#define MSMFB_IMG_TRANSFER_ON  _IO(MSMFB_IOCTL_MAGIC, 181)
#define MSMFB_IMG_TRANSFER_OFF _IO(MSMFB_IOCTL_MAGIC, 182)
...
#define MSMFB_CABC_KCJPROP_DATA_NUM 1
